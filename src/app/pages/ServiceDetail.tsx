...
export function ServiceDetail() {
  ...
  if (parentService) {
    return <Navigate to={parentService.path} replace />;
  }
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="border-t border-zinc-200">
                {service.approaches.map((approach, index) => (
                  <ScrollReveal key={approach.title} delay={index * 0.05}>
                    <article className="grid grid-cols-1 gap-8 border-b border-zinc-200 py-10 xl:grid-cols-[180px_320px_minmax(0,1fr)] xl:gap-10">
                      <div>
                        <p className="text-sm font-bold tracking-widest text-cyan-500">
                          {approach.label}
                        </p>
                      </div>
                      <h3 className="text-2xl font-bold leading-tight text-zinc-900">{approach.title}</h3>
                      <div>
                        <p className="text-zinc-600 leading-relaxed">{approach.description}</p>
                        <ul className="mt-6 space-y-3 text-zinc-600 leading-relaxed">
