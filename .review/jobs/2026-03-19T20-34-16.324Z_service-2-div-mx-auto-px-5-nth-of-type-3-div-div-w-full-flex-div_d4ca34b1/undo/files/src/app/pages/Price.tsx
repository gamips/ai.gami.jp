...
const pricePlans: PricePlan[] = [
  ...
  },
  {
    ...
    lead: "初期学習目安 1カ月",
    description:
      "AI × Growth / AI × Support は、まずエージェントにブランド文脈と業務ルールを学習させる初期導入から始めます。約1カ月で初期学習を終えた後は、1エージェントごとの月額レンタルで提供します。SEO記事作成やSNS運用の下書き支援に加え、freee会計や弥生会計の決算補助、日々のスケジュール管理、勤怠管理などの定型業務自動化を標準想定とし、負荷の高い追加要件は別途相談です。なお対象は初期学習とレンタルまでで、日々の実運用代行は含みません。",
  },
  {
    slug: "ai-web",
    fee: "50万円 / 月",
...
const projectNotes = [
  {
    ...
    body:
      "AI × Growth / AI × Support は、エージェントの初期学習と貸し出しまでが対象です。実際の投稿運用代行や、日々の経理・事務の完全代行までは含まれません。運用体制まで必要な場合は、別体制や別プランの相談が必要になります。",
  },
  {
    title: "既存データ移行の考え方",
    body:
