              ...
              <div className="space-y-8">
                {[
                  ...
                  <ScrollReveal key={index} delay={index * 0.1}>
                    <Link
                      to="/news"
                      className="block border-b border-zinc-200 pb-6 hover:border-cyan-500 transition-colors group"
                    >
                      ...
                      <h3 className="text-xl font-medium group-hover:text-cyan-500 transition-colors text-zinc-900">
                        {news.title}
                      </h3>
                    </Link>
                  </ScrollReveal>
